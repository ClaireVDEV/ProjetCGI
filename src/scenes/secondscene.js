async function secondscene(BABYLON, engine, currentScene) {
    ...
    const cam = new BABYLON.ArcRotateCamera("arcCamera", BABYLON.Tools.ToRadians(0), BABYLON.Tools.ToRadians(45), 10, sphere.position, scene);
